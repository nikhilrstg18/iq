...
| Topics Covered     | [2.1 Operators](#operators)<br/>[2.1.1 Unary](#unary)<br/>[2.1.2 Binary](#binary)<br/>[2.1.3 Ternary or Conditional](#ternary-or-conditional) <br/>[2.1.4 Optional Chaining](#optional-chaining)<br/>[2.1.5 Assignment](#assignment)<br/>[2.1.6 Comparison](#comparison)<br/>[2.1.7 Arithmatic](#arithmatic)<br/>[2.1.8 Bitwise](#bitwise)<br/>[2.1.9 Logical](#logical)<br/>[2.1.10 Misc](#misc)<hr /> [2.2 Expressions](#expressions) <hr />[2.3 Data Types](#data-types) <hr />[2.4 Type Conversion and Coercion](#data-types)                                                                                                                                                                                                                                                                                                             |
...
---
#### Optional Chaining 
operator enables you to read the value of a property located deep within a chain of connected objects without having to check that each reference in the chain is valid
...
| Nullish coalescing operator | ??         | returns its right-hand side operand when its left-hand side operand is null or undefined, and otherwise returns its left-hand side operand                                                                                                                                                                                 | [View](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing_operator) |
