...
| Topics Covered | [2.0 **Comments**](#comments)<hr />2.1 **Operators**<br/>[2.1.1 Unary](#unary)<br/>[2.1.2 Binary](#binary)<br/>[2.1.3 Ternary or Conditional](#ternary-or-conditional) <br/>[2.1.4 Assignment](#assignment)<br/>[2.1.5 Comparison](#comparison)<br/>[2.1.6 Arithmatic](#arithmatic)<br/>[2.1.7 Bitwise](#bitwise)<br/>[2.1.8 Logical](#logical)<br/>[2.1.9 Misc](#misc)<hr /> [2.2 **Expressions**](#expressions) <hr />[2.3 **Data Types**](#data-types) <hr />[2.4 **Type Conversion and Coercion**](#types-casting--coercion)<hr/> **Declarations & Statements**<hr />2.5 Declaring Variables <br/>[2.5.1 `var`](#var)<br/>[2.5.2 `let`](#let)<br/>[2.5.3 `const`](#const) <hr/>2.6 Declaring functions & classes <br/>[2.6.1 `function`](#function)<br/>[2.6.2 `function*`](#function)<br/>[2.6.3 `async function`](#async-function)<br/>[2.6.4 `async function*`](#async-function)<br/>[2.6.5 `class`](#class) <hr/>2.7 Control Flow Statements<br/>[2.7.1 `return`](#return)<br/>[2.7.2 `break`](#break)<br/>[2.7.3 `continue`](#continue)<br/>[2.7.4 `throw`](#throw)<br/>[2.7.5 `if...else`](#ifelse)<br/>[2.7.6 `switch`](#switch) <br/>[2.7.7 `try...catch`](#trycatch)<hr/>2.8 Looping Statements <br/>[2.8.1 `while`](#while)<br/>[2.8.2 `do-while`](#do-while)<br/>[2.8.3 `for`](#for)<br/>[2.8.4 `for...in`](#forin)<br/>[2.8.5 `for...of`](#forin)<br/>[2.8.6 `for await...of`](#for-awaitof)<hr/>2.9 Misc. Statements <br/>[2.9.1 `empty`](#empty)<br/>[2.9.2 `block`](#block)<br/>[2.9.3 `debugger`](#debugger)<br/>[2.9.4 `export`](#export)<br/>[2.9.5 `import`](#import)<br/>[2.9.6 `label`](#label)<br/>[2.9.7 `with`](#with) |
